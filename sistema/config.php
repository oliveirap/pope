...
define('URL_BT', URL_BASE.'assets/css/bootstrap.min.css');
define('URL_BTHEME', URL_BASE.'assets/css/bootstrap-theme.min.css');
...
define("FILE_NAV_TOPO", DIR_BASE.'assets/parciais/top_nav.php');
// Modulos
define('FILE_MCONFIG', DIR_BASE.'assets/modulos/mconfig.php');
define('FILE_REGEX', DIR_MODULOS.'regex.php');
define("FILE_ADMIN_FUNCTIONS", DIR_MODULOS."admin_functions.php");
?>
